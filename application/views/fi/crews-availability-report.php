...
<head> -->
  ...
  <title>ERP System | Expense Detail Report By Account </title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Expense Detail Report By Account</li>
              ...
              <div class="box-header with-border">
                <div class="row">
                  <div class="col-sm-5 col-md-4">
                    <h3 class="uhead1">
                      Expense Detail Report By Account
                    </h3>
                  </div>
                    ...
                    <div class="table-responsive">
                      <table class="table fixed_table table-hover no-margin mw800">
                        <thead>
                          <tr>
                            <th class="w30">#</th> 
                            <th class="w120"> Customer</th> 
                            <th class="">Event</th> 
                            <th class="w90"> Date</th> 
                            <th class="w100"> Phone</th> 
                            <th class="w150"> Referred By</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <tr>
                              <td> 1</td>  <td>Reisz,</td>  <td> Wedding</td>  <td> 1/8/19 </td>  <td>(347) 266-2274</td>  <td> Serhofer, -</td> </tr> 
                              <td> 2</td>  <td>Matyas,</td>  <td> Wedding</td>  <td> 1/12/19 </td>  <td>(347) 266-2274</td>  <td> Serhofer, -</td> </tr> 
                              <td> 3</td>  <td>Glassman,</td>  <td> Wedding</td>  <td> 1/13/19 </td>  <td>(347) 266-2274</td>  <td> Serhofer, -</td> </tr> 
                              <td> 4</td>  <td>Gottesman,</td>  <td> Wedding</td>  <td> 1/18/19 </td>  <td>(347) 266-2274</td>  <td> Serhofer, -</td> </tr> 
                              <td> 5</td>  <td>Reisz,</td>  <td> Wedding</td>  <td> 1/21/19 </td>  <td>(347) 266-2274</td>  <td> Serhofer, -</td> </tr> 
