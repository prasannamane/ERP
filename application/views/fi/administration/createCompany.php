...
<section class="content">
  <!-- TABLE: LATEST ORDERS -->
  <div class="row">
    <form action="<?=site_url('Fi_home_ajax/addnewuser')?>" method="POST" name="pform" id="pform">
      <div class="col-md-6">
              ...
              <div class="col-md-12">
                ...
                <div class="form-horizontal">
                  <div class="form-group nospacerow">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control fcap" name="user_fname" id="user_fname" style="text-transform: uppercase;" type="text" placeholder="Enter Name">
                    </div>

                    <div class="col-sm-5">
                        <input class="form-control" name="user_password" id="user_fname" type="text" placeholder="Enter Password">
                    </div>
                </div>

                <div class="form-group nospacerow">
                    <div class="col-sm-12">
                        <input class="form-control" name="company" id="" type="text" placeholder="Enter Company">
                    </div>
                </div>

                <div class="form-group nospacerow">
                    <div class="col-sm-12">
                        <input class="form-control group fcap" name="user_name" id="user_name" type="text" placeholder="User Name">
                    </div>
                </div>
        ...
        <div class="col-md-12 text-center">
          ...
          <a href="<?=site_url('fi_home/administration_user_rights/')?>" class ="btn btn-lg btn-default btn-flat">Back</a>
        </div>
      </form>
    </section>
 <!-- /.content -->
