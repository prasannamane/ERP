          ...
          <div class="col-md-12">
            ...
            <div class="box box-info">
              ...
              <div class="box-body">
                ...
                <form id="frmaddlettersdetails" name="frmaddlettersdetails" action="<?=site_url('Administration/addcrew_template')?>" method="post">
                  <?php //echo "<pre>";print_r($temp_cat); ?>
                  <div class="form-group">
                    <div class="row">
                       <div class="col-sm-4">
                         Enter Name
                         <input class="form-control fcap" placeholder="Name" type="text" name="txtlettertyp" id="txtlettertyp" value="" required >

                       </div>

                        <div class="col-sm-4">
                          Enter Template Name
                          <input class="form-control fcap" placeholder="Enter Template Name" type="text" name="template_name" id="template_name" value="" required >
                        <!-- <select class="form-control" name="template_name">
                           <option> </option>
                           <?php //$i=1;
                          // foreach ($temp_cat as $temp_cat)
                           // echo "<pre>";  print_r($driver);die;
                           {?>
                           <option value="<?= $temp_cat['sub_name']; ?>"><?= $temp_cat['sub_name']; ?></option>
                         <?php }?>
                        </select> -->
                       </div>
                      </div>
                  ...
                  <div class="form-group">
                      <div class="col-sm-8">
                          <textarea class="fcap" placeholder="Description" id="textletterdetails" name="textletterdetails" rows="5" cols="80" required></textarea>
                      </div>
