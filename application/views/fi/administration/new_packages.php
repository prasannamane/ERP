...
<body class="hold-transition skin-blue sidebar-mini administration_package">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <!-- TABLE: LATEST ORDERS -->
            <form action="<?= site_url('Administration/admin_packages/') ?>" method="POST" id="iform" name="iform">
                <div class="row">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table   table-hover no-margin">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>1</td>
                                                <td><input type="text" class="form-control" name="package_name" id="id" onchange="fngetitemtot()" required /></td>
                                                <td>
                                                ...
                                                <td><input type="text" name="package_desc" id="package_desc" style="width: 100%;" /></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
