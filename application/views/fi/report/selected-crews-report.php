<!DOCTYPE html>
    ...
    <title>ERP System | Selected Crews Report </title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Selected Crews </li>
                    ...
                    <div class="table-responsive">
                      <table class="table fixed_table table-hover no-margin mw800">
                        <thead>
                          <tr>
                            <th class="w30">#</th> 
                            <th class="w280">Customer</th> 
                            <th class="">Event</th> 
                            <th class="w280"> Start Time</th>  
                            <th class="w180"> Event Name</th>  
