...
<head> -->
  ...
  <title>ERP System | Profit Report By Event </title>
              ...
              <div class="box-header with-border">
                <div class="row">
                  <div class="col-sm-5 col-md-4">
                    <h3 class="uhead1"> Profit Report By Event </h3>
                  </div>
                    ...
                    <div class="table-responsive">
                      <table class="table fixed_table table-hover no-margin mw800">
                        <thead>
                          <tr>
                            <th class="w30">#</th> 
                            <th class="w180"> Customer</th> 
                            <th class="">Event</th> 
                            <th class="w90"> Date</th> 
                            <th class="w110"> Phone</th> 
                            <th class="w90"> Income</th> 
                            <th class="w90"> Purchases </th>
                            <th class="w90"> Profit</th>
                          </tr>
                        </thead>
                        <tbody>
