...
?>
	...
	public function fngetinvoiceinfo_dtls($cusid)
	{
		...
		$itemsql = $this->db->query("SELECT i.item_taxble,i.inv_id,i.assigned_pckid,i.id,i.item_name,i.item_quantity,i.item_price,i.item_desc,i.item_descount,p.package_price 
            FROM customers_package_items AS i,customer_assigned_packages AS p WHERE i.package_id=p.package_id AND p.inv_id='" . $_POST['invoiceid'] . "' AND i.inv_id='" . $_POST['invoiceid'] . "' ORDER BY id ASC");
		$lastitemsql = $this->db->query("SELECT * FROM customers_package_items WHERE package_id='" . $selpackage . "' AND inv_id='" . $_POST['invoiceid'] . "' ORDER BY id DESC ");
									...
									<table class="table table-hover no-margin fixed_table w1000" style="width:99.90%; min-width:1000px;">
										...
										<thead>
											...
											<tr>
												...
												<th class="hide_in_invoice" style="width: 7%;"><span style=" display: inline-block;">Package *</span></th>
										...
										<?php
										$commonpckgsql = $this->db->query("SELECT * FROM customer_assigned_packages WHERE inv_id='" . $_POST['invoiceid'] . "' ORDER BY id ASC");

										$srno = 1;
										$no_focus = "focus3";
										foreach ($commonpckgsql->result() as $pckitmsql_dtls) {
										...
										?>
											<tbody id="pckitems" class="pckitems">
												<!-- Start Pckages loop -->
												<tr class="tr_clone auto-index package_line 7" style="background: #e2e2e2;">
													...
													<td class="hide_in_invoice" style="width:7%;">
														<span class="inline_block" style=""><input class="form-control w110" type="text" value="<? //=$pckitmsql_dtls->package_name
																																				?>"></span>
													...
													<td style="width:4.95%;" class="hide_in_invoice">
														<div class="form-group " style="width: 100%; display: block;">
															<div class="input-group" style="width: 100%; ">
																<span class="input-group-addon " style="width: 100%; ">
																	<select name="pck_discount<?= $pckitmsql_dtls->id ?>" id="pck_discount<?= $pckitmsql_dtls->id ?>" class="form-control" style="width: 100%; min-width: 55px; margin-top: -4px;" onchange="fnupdatepckgdescount(this.value,'<?= $pckitmsql_dtls->inv_id ?>','<?= $pckitmsql_dtls->cus_id ?>','<?= $pckitmsql_dtls->package_price ?>','<?= $pckitmsql_dtls->pck_discnt_amt ?>','<?= $pckitmsql_dtls->id ?>', '<?= $pckitmsql_dtls->pck_discounted_amt ?>')">
																		<option value="">Choose </option>
													...
													<td style="width:7.90%;" class="hide_in_invoice">
														<div class="form-group ">
															<div class="input-group">
																<?php
																if ($pckitmsql_dtls->pck_discnt_amt == 0) {
																	$pckitmsql_dtls->pck_discnt_amt = "";
																}
																?>
																<input type="text" name="pck_descnt<?= $pckitmsql_dtls->id ?>" id="pck_descnt<?= $pckitmsql_dtls->id ?>" class="form-control" style="width: 90px;" value="<?= $pckitmsql_dtls->pck_discnt_amt ?>" onchange="fnupdatepckgdescnt(this.value,'<?= $pckitmsql_dtls->inv_id ?>','<?= $pckitmsql_dtls->cus_id ?>','<?= $pckitmsql_dtls->package_price ?>','<?= $pckitmsql_dtls->pck_discnt_typ ?>','<?= $pckitmsql_dtls->id ?>')">
															</div>
														</div>
													</td>
													...
													<td style="width:5%;">
														<div class="form-group ">
															<div class="input-group"><span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span></span>
																<input type="text" disabled name="pck_total<?= $pckitmsql_dtls->id ?>" id="pck_total<?= $pckitmsql_dtls->id ?>" class="form-control" style="width: 90px;" value="<?= sprintf('%0.2f', $pckitmsql_dtls->package_price) ?>">
															</div>
														</div>
													</td>
													...
													<td style="width:5%;" class="hide_in_invoice">
														<div class="form-group ">
															<div class="input-group">
																<span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span></span>
																<input type="text" name="pck_discnted_amt<?= $pckitmsql_dtls->id ?>" id="pck_discnted_amt<?= $pckitmsql_dtls->id ?>" class="form-control" style="width: 90px;" value="<?= sprintf('%0.2f', $pckitmsql_dtls->pck_discounted_amt) ?>" disabled>
															</div>
														</div>
													</td>
													...
													<td style="width:5%;" class="hide_in_invoice">
														<div class="form-group ">
															<div class="input-group">
																...
																<input type="text" name="pck_sub_amt<?= $pckitmsql_dtls->id ?>" id="pck_sub_amt<?= $pckitmsql_dtls->id ?>" class="form-control" style="width: 90px;" value="<?= sprintf('%0.2f', ($pckitmsql_dtls->sub_total)) ?>" disabled>
															</div>
														</div>
													</td>

													<!-- <?= sprintf('%0.2f', ($pckitmsql_dtls->package_price - $pckitmsql_dtls->pck_discounted_amt)) ?> -->
													...
													<td style="width:4%;" class="hide_in_invoice">
														<span style=" display: inline-block;">
															...
															<input type="hidden" name="pcktot<?= $pckitmsql_dtls->id ?>" id="pcktot<?= $pckitmsql_dtls->id ?>" value="<?= sprintf('%0.2f', $pckitmsql_dtls->package_price) ?>">
													...
													<td colspan="11">
														<div class="ibox-content" style="padding: 0;">
															...
															<table class="table table-hover no-margin fixed_table w1000">
																<?php
																$commonpckitemsgsql = $this->db->query("SELECT * FROM customers_package_items 
                          WHERE inv_id='" . $_POST['invoiceid'] . "' AND package_id='" . $pckitmsql_dtls->package_id . "' AND assigned_pckid='" . $pckitmsql_dtls->id . "' ORDER BY id ASC"); //LIMIT 1
																$rno = 1;

																//print_r($commonpckitemsgsql->result()); 
																...
																foreach ($commonpckitemsgsql->result() as $pckitmsql_dtls1) {
																	...
																	//echo "SELECT * FROM customer_assigned_packages WHERE id='".$pckitmsql_dtls1->assigned_pckid."' ORDER BY id ASC";
																...
																?>
																	...
																	<tbody id="pcksubitems" class="">
																		<tr class="tr_clone auto-index pck_items 8">
																			<td style="width:4.01%;">
																				<input type="text" name="" id="" onblur="change_qty1(<?= $itmId ?>, this.value)" class="form-control pck_itemwoutqty" value="<?= $pckitmsql_dtls1->item_quantity ?>">
																			</td>
																			...
																			<td style="width:5%;">
																				<input type="hidden" class="pck_hdninvoicrcId" name="" id="" value="<?= $_POST['invoiceid'] ?>">
																			...
																			<td style="width:8%;">
																				<div class="form-group ">
																					<div class="input-group">
																						...
																						?>
																						<input type="text" name="" id="" class="form-control pck_item_discnt_amt" style="width: 90px;" value="<?= $pckitmsql_dtls1->item_discnt_amt ?>">
																					</div>
																				</div>
																			...
																			<td style="width:4%;" class="hide_in_invoice">
																				...
																				<input class=" " <?= $taxchksts ?> type="checkbox" value="<?= $settaxval ?>" id="iteam_taxable<?= $itmId ?>" name="iteam_taxable<?= $itmId ?>" onchange="fnupdateitemtax(this.value,'<?= $itmId ?>','<?= $pckitmsql_dtls1->inv_id ?>')">
																			</td>
									...
									<?php
									$isexistsitemsql = $this->db->query("SELECT * FROM customers_package_items WHERE package_id IS NULL AND inv_id='" . $_POST['invoiceid'] . "' AND cus_id='" . $_POST['custnm'] . "' ORDER BY id ASC ");
									$lstitemrow = $this->db->query("SELECT * FROM customers_package_items WHERE package_id IS NULL AND inv_id='" . $_POST['invoiceid'] . "' AND cus_id='" . $_POST['custnm'] . "' ORDER BY id DESC LIMIT 1");
									$getitemrow = $lstitemrow->row();
									if ($isexistsitemsql->num_rows() > 0) {
									?>
										<div role="tabpanel" class="tab-pane active 2" id="items">
											<div class="box box-default " style="width: max-content; max-width: max-content; padding: 0; box-shadow: none; ">
												<div class="box-body" style="padding: 0; ">
													...
													<div class="row">
														...
														<div class="col-sm-12">
															...
															<div class="table-responsive" id="loaditms" style="width: inherit;overflow-x: visible;">
																...
																<table class="table table-hover no-margin fixed_table w1000" style="width:99.85%;">
																	...
																	foreach ($isexistsitemsql->result() as $pckitmsql_dtls) {
																		...
																		$lstinvoiceid = "fa-minus";
																		$lstinvoicecls = "btn-danger";
																		$fninvoce = "fndelpitem('" . $pckitmsql_dtls->id . "','" . $_POST['invoiceid'] . "')";
																	...
																	?>
																		...
																		<thead id="lstpckitems" style="border-top: 1px solid #ccc; ">
																			...
																			<tr class="tr_clone auto-index 9">

																				<td style="width:4%;text-align:center; ">
																					<input type="hidden" class="hdnitemrowId" name="hdnitemrowId" id="hdnitemrowId" value="<?= $itmId ?>">
																					<!--  <input type="text" class="hdnitemrowId" name="hdnitemrowId" id="hdnitemrowId" value="<?php print_r($pckitmsql_dtls); ?>"> -->
																					<!--  <?= $_POST['invoiceid'] ?> -->
																					<input type="hidden" class="hdninvoicrcId" name="hdninvoicrcId" id="hdninvoicrcId<?= $itmId ?>" value="">
																					<!-- onblur="change_qty(<?= $itmId ?>, this)" -->
																					<input type="text" name="item_quantity<?= $itmId ?>" id="i1<?= $itmId ?>" min="1" class="form-control itemwoutqty text-center" value="<?= $pckitmsql_dtls->item_quantity ?>">
																				</td>
																				...
																				<td style="width:8%">
																					<select onchange="fnupdateitemamountp(this.value,'<?= $itmId ?>')" class="form-control 2" name="item_name<?= $itmId ?>" id="i2<?= $itmId ?>" onblur="fnupdateiteminfo(this.value,'<?= $pckitmsql_dtls->inv_id ?>','<?= $pckitmsql_dtls->id ?>')">
																						<option value="">Choose</option>
																				...
																				<td style="width:23%">
																					<input type="text" onchange="fnupdateitemdescp(this.value,'<?= $itmId ?>')" name="item_desc<?= $itmId ?>" id="i3<?= $itmId ?>" class="form-control 2" value="<?= $pckitmsql_dtls->item_desc ?>">
																				</td>
																				...
																				<td style="width:5%">
																					...
																					<select name="item_discount" id="item_discount" class="form-control updwn itemdiscntyp">
																						<option value=""> Choose</option>
																				...
																				<td style="width:8%">
																					<input type="text" name="item_descnt" id="item_descnt" class="form-control updwn itemdescount" value="<?= $pckitmsql_dtls->item_discnt_amt ?>">
																				</td>
																				...
																				<td style="width:5%">
																					<div class="form-group">
																						<div class="input-group">
																							...
																							<input type="text" onchange="fnupdateitemamountp(this.value,'<?= $itmId ?>')" name="item_amount<?= $itmId ?>" id="i4<?= $itmId ?>" class="form-control witmi4 1 total_focus_me_<?= $itmId ?>" value="<?= sprintf('%0.2f', $pckitmsql_dtls->item_price) ?>">
																						</div>
																					</div>
																				</td>
																				...
																				<td style="width:5%">
																					<div class="form-group">
																						<div class="input-group">
																							<span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span></span>
																							<input type="text" name="itm_discnt_amt" id="itm_discnt_amt" class="form-control" value="<?= sprintf('%0.2f', $pckitmsql_dtls->discounted_amt) ?>" disabled>
																						</div>
																					</div>
																				...
																				<td style="width:5%">
																					<div class="form-group">
																						<div class="input-group">
																							...
																							<input type="text" disabled name="item_total<?= $itmId ?>" id="i5<?= $itmId ?>" class="form-control itmtot" value="<?php

																																																				if ($pckitmsql_dtls->item_discnt_typ == 1) {
																				...
																				<td style="width:4%">
																					<!-- <input type="checkbox" value="1" id="iteam_taxable<?= $itmId ?>" name="iteam_taxable<?= $itmId ?>"> -->
																					<?php
																				...
																				<td style="width:4%">
																					<?php if ($pckitmsql_dtls->id != '' && $_POST['invoiceid'] > 0) { ?>
																						<input type="hidden" class="1" name="pcktot" id="pcktot" value="<?= sprintf('%0.2f', $pckitmsql_dtls->package_price) ?>">
																						<?php $fninvoce1 = "fndelpitem('" . $pckitmsql_dtls->id . "','" . $_POST['invoiceid'] . "')"; ?>
																						<a onclick="<?= $fninvoce1 ?>" class="btn btn-xs <?= $lstinvoicecls ?>">
																							<i class="fa <?= $lstinvoiceid ?>"></i></a>
																					<?php } ?>
																				</td>
																			</tr>
																		</thead>
																	...
																	<input type="hidden" name="" class="total_focus_me" value="<?= $itmId ?>">


																	<!-- start  blank row for only add itmes  -->


																	<thead id="oopckitems">
																		<tr class="tr_clone auto-index 10">
																			<td style="width:4%;">
																				<input type="text" name="item_quantity" style="background: #d0d0d0 !important;" readonly="" id="i1" class="form-control focus3 take_my_data" value="" onblur="focus3()" onfocus="">
																			</td>
																			<td style="width:11%;">
																				<span class="next_tab4  dblock"></span>
																			</td>
																			<td style="width:14%;">
																				<!-- onchange="fniteminfo(this.value)" -->
																				<select class="form-control 1 item_quantity_select" name="item_name" id="i2" onchange="fniteminfo(this.value)">
																					<option value="">Choose</option>
																					<?php
																			...
																			<td style="width:17%;">
																				<input tabindex="-1" type="text" name="item_desc" id="i3" class="form-control" value="">
																			</td>
																			<td style="width:5%;">
																				<select tabindex="-1" name="item_decntlist" id="item_decntlist" style="width: 100%; ">
																					<option value="">Choose </option>
																			...
																			<td style="width:8%;">
																				<div class="form-group">
																					<div class="input-group">
																						<span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span></span>
																						<input type="text" name="item_amount" id="i4" class="form-control 1" value="0.00" onblur="fniteminfo(this.value)">
																					</div>
																				</div>
																			</td>
																			...
																			<td style="width:8%;">
																				<div class="form-group">
																					<div class="input-group">
																						<span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span></span>
																						<input tabindex="-1" type="text" name="item_total" id="i5" class="form-control" value="0.00">
																					</div>
																				</div>
																			</td>

																			<td style="width:8%;">
																				<!-- <span class="w110 dblock"></span> -->

																				<div class="form-group">
																					<div class="input-group">
																						<span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span></span>
																						<input tabindex="-1" type="text" name="discnt_tot" id="discnt_tot" class="form-control" value="0.00">
																					</div>
																				</div>
																			...
																			<td style="width:5%;">
																				<input tabindex="-1" type="checkbox" value="1" name="iteam_taxable">
																			</td>
									...
									?>
										<div class="box-body" style="padding:0;">
											<div class="row">
												<div class="col-sm-12">
													<div class="" id="loaditms">
														<table class="table table-hover no-margin fixed_table w1000" style="width:99.90%; min-width: 999px;">
															<thead id="pckitems" class="pckitems1">
																<tr class="tr_clone auto-index 11">
																	<td style="width:4%;">
																		<input type="text" name="item_quantity" style="background: #d0d0d0 !important;" id="i1" class="form-control focus3 take_my_data4" readonly="" value="<?= $setitemqty ?>" onblur="focus4()">
																	</td>
																	<td style="width:7%">
																		<span class="w120 dblock"></span>
																	<td style="width: 8%">
																		<!-- onchange="fniteminfo(this.value)"  -->
																		<select class="form-control 2 item_quantity_select2" name="item_name" id="i2" onchange="fniteminfo(this.value)">
																			<option value="">Choose</option>
																			<?php
																	...
																	<td style="width: 23%">
																		<input tabindex="-1" type="text" name="item_desc" id="i3" class="form-control" value="<?= $setitemdesc ?>">
																	</td>

																	<td style="width: 5%">

																		<select name="item_decntlist" id="item_decntlist" tabindex="-1" class="form-control">
																			<option value=""> Choose</option>
																			<option value="1">$</option>
																			<option value="2">%</option>
																		</select>
																	...
																	<td style="width: 5%">
																		<div class="form-group">
																			<div class="input-group">
																				...
																				<input type="text" name="item_amount" id="i4" class="form-control 2" style="" value="<?= sprintf('%0.2f', $setitemamt) ?>" onblur="fniteminfo(this.value)">
																			</div>
																		</div>
																	</td>
																	...
																	<td style="width: 5%">
																		<div class="form-group">
																			<div class="input-group">
																				<span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span></span>
																				<input type="text" name="item_total" id="i5" class="form-control" style="" value="<?= sprintf('%0.2f', $setitemtot) ?>">
																			</div>
																		</div>
																	</td>
																	...
																	<td style="width:4%"> <input class="" type="checkbox" value="1" name="iteam_taxable"></td>
								...
								<div class="box box-default thirdblock_bg ">
									<table class="table table-hover no-margin nobg">
										<thead>
											...
											<?php
											$pckgrandtotal = "";
											$singlpckgsql = $this->db->query("SELECT * FROM customer_assigned_packages WHERE inv_id='" . $_POST['invoiceid'] . "' ORDER BY id ASC LIMIT 1");
											$singlpckgsql_row = $singlpckgsql->row();
											$pckgsql = $this->db->query("SELECT * FROM customer_assigned_packages WHERE inv_id='" . $_POST['invoiceid'] . "' ORDER BY id ASC");
												...
												<tr class="auto-index tr_clone">
													...
													<td>
														<div class="form-group">
															<div class="input-group">
																<span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span></span>
																<input type="text" name="item_price" id="pri" class="form-control totsum updwn" style="width: 80px;" value="<?= sprintf('%0.2f', $pckgsql_dtls->package_price) ?>" onchange="fnupdatepckgeamount(this.value,'<?= $_POST['invoiceid'] ?>','<?= $selpackage ?>','<?= $pckgsql_dtls->id ?>','<?= $pckgsql_dtls->pck_discnt_typ ?>','<?= $pckgsql_dtls->pck_discnt_amt ?>')"><!--  itempckprice -->
													...
													<td> <?php $invoiceid = $_POST["invoiceid"]; ?>
														<a class="btn btn-xs btn-danger" onclick="fndelassignpackge('<?= $pckgsql_dtls->id ?>','<?= $pckgsql_dtls->package_price ?>','<?= $invoiceid ?>')"><i class="fa fa-minus"></i></a>
													</td>
											...
											<tr class="auto-index tr_clone">
												...
												<td>
													<select class="form-control focus2" name="item_package_name" id="itemPackageName" onclick="fngetsinglepckinfo(this.value)">
														<option value="">Select</option>
														<?php
														$all_packs = $this->db->query("SELECT * from admin_package");
										...
										<td>
											<div class="form-group">
												<div class="input-group">
													<span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span></span>
													<input tabindex="-1" type="text" name="item_price" id="pri" class="form-control totsum updwn" style="width: 80px;" value="" placeholder="0.00">

													<input tabindex="-1" type="hidden" name="invId" id="invId" class="form-control" style="width: 80px;" value='<?= $_POST["invoiceid"] ?>'>
												</div>
											</div>
										</td>

										<td>
											<!-- <a class="btn btn-xs btn-success addnewpck" ><i class="fa fa-plus"></i></a> -->
										</td>
								...
								<table class="table table-hover no-margin">
									...
									<tbody id="dispterms">
										...
										foreach ($invotermsql->result() as $invotermsql_dtls) {
											...
											//$chkadmtermssql=$this->db->query("SELECT * FROM adm_terms_type WHERE id='".$invotermsql_dtls->name."'");
											//$chkadmtermssqlrow=$chkadmtermssql->row();

											//"Remaining Balance"
											//if($invotermsql_dtls->amount=="Remaining Balance")
											if ($invotermsql_dtls->totsts == 1) {
												if ($isinvtermsrow->id == $invtrmsId) {
													$setamount = $trmsum;
										...
										?>
											...
											<tr class="tr_clone">
												<td>
													...
													<select class="form-control txttermstype 1" id="txttermstype" name="txttermstype">
														<option> </option>
														<?php
														$admtermssql = $this->db->query("SELECT * FROM adm_terms WHERE subcat_id='" . $invotermsql_dtls->subcat_id . "' ORDER BY id ASC");
					...
					<table class="table table-hover no-margin fixed_table">
						...
						<thead>
							...
							<tr>
								...
								<th class="w160">Task</th>

								<th class="w160">Sub Task</th>
								...
								<th class="w110">Completed Date</th>

								<th>Note</th>

								<th class="w120">Entered By</th>
						...
						<tbody id="mytasks">
							...
							<?php
							if (is_numeric($_POST['invoiceid']) == 1) {
							...
							?>
										...
										<tr class="tr_clone" style="<? //=$rwcolor
											...
											<td style="background-color: <?= $assigntskcolor ?>">
												...
												<!--<input type="date" name="task_strtdate" id="task_strtdate" class="form-control taskstrtdate w95" value="<?= ($dt != "01/01/1970") ? $dt : ""; ?>" >-->
												<input type="text" name="task_strtdate" id="task_strtdate" class="form-control taskstrtdate w95" value="<?= ($dt != "01/01/1970") ? $dt : ""; ?>">
											...
											<td style="background-color: <?= $assigntskcolor ?>">
												...
												<select class="form-control taskuser task_name" name="task_name" id="task_name" style="width: 130px;">
													<option value=""> </option>
													<?php
											...
											<td style="background-color: <?= $assigntskcolor ?>">
												<select class="form-control taskuser subtaskname" name="subtaskname" id="subtaskname" style="width: 130px;">
													<option value=""> </option>
													<?php
											...
											<td style="background-color: <?= $assigntskcolor ?>">
												...
												<select class="form-control text-center" name="task_user" id="task_user" onchange="fnupdatetaksinfo(this.value,'<?= $taskId ?>','task_user')">
													<option value=""> </option>
													<?php
											...
											<td style="background-color: <?= $assigntskcolor ?>">
												...
												<input type="text" name="task_due_date" id="task_due_date" class="form-control taskduedate w80" placeholder="mm/dd/yyyy" value="<?= ($dt != "01/01/1970") ? $dt : ""; ?>" onblur="fnupdatetaksinfo(this.value,'<?= $taskId ?>','task_due_date')">
											</td>
                            ...
                            <label>-->
												...
												/*  if($taskcompleted==1)
                                 {
                                    ...
                                    $setflg="0";
                                     ...
                                     $setflg="1";
												...
												<select class="form-control taskcompleted" name="task_completed" id="task_completed" onchange="fnupdatetaksinfo(this.value,'<?= $taskId ?>','task_completed')">
													<option value=""> </option>
													<?php
											...
											<td style="background-color: <?= $assigntskstscolor ?>">
												...
												?>
												<input type="text" name="task_enter_by" id="task_enter_by" class="form-control taskenterby updwn text-center" value="<?= $logedusername ?>" readonly>
											</td>

											<td style="min-width: 40px; width: 40px;">
												<a onclick="fndeltasks('<?= $taskId ?>','<?= $taskinvId ?>')" class="btn btn-xs btn-danger "><i class="fa fa-minus"></i></a>
												<!--  <button onclick="<?= $fntask ?>" class="btn btn-xs <?= $lsttaskcls ?>"><i class="fa <?= $lsttaskid ?>"></i></button> -->
								...
								<tr class="tr_clone">
									<td>
										<input type="text" name="task_strtdate" id="task_strtdate" class="form-control lsttaskstrtdate text-center" value="<?= date('m/d/Y') ?>">

										<input type="hidden" name="hdntskinvd" class="hdntskinvd" value="<?= $_POST['invoiceid'] ?>">
									</td>

									<td>
										<!--  <input type="text" name="task_name" id="task_name" class="form-control taskname" value=""> -->
									...
									<td>
										...
										<select class="form-control" name="task_user" id="task_user" style="width: 130px;">
											<option value=""> </option>
											<?php
											$admloguser = $this->db->query("SELECT * FROM register_customer ORDER BY cus_id DESC");
											foreach ($admloguser->result() as $admloguser_dtls) {
											?>
												<option value="<?= $admloguser_dtls->cus_id ?>"><?= $admloguser_dtls->cus_lname ?></option>
											<?php
											}
											?>
										</select>
                            ...
                            <input  type="checkbox" value="" name="task_completed" id="task_completed" class="taskcompleted"></label>
									...
									<td><input type="text" name="task_completed_date" id="task_completed_date" class="form-control taskcompleteddate text-center" value=""></td>
									...
									<td>
										<!--<a onclick="fncrtasks('<? //=$_POST['invoiceid']
					...
					<div class="row">
								...
								<div class="table-responsive">
									<table class="table table-hover no-margin fixed_table">
										<thead>
											...
											<?php
											$pckupitemsql = $this->db->query("SELECT * FROM customers_pickup_items WHERE inv_id='" . $_POST['invoiceid'] . "' ORDER BY id ASC");
											$srno = 1;
											...
											?>
												<tr class="tr_clone">
													<td><?= $srno ?>
														...
														<input type="hidden" name="invoiceid" id="invoiceid" class="form-control invoiceid" value="<?= $_POST['invoiceid'] ?>">
													</td>
													...
													<td>
														<!--  <input type="text" name="pickup_quantity" class="form-control" value="<?= $pckupitemsql_dtls->item_quantity ?>" disabled> -->
													...
													<td>
														...
														<!--     <input type="text" name="pickupby" class="form-control pickupby" value="<?= $pckupitemsql_dtls->pickup_by ?>" onchange="fnupdatepickpedinfo(this.value,'<?= $pckupitemsql_dtls->id ?>','pickup_by','<?= $pckupitemsql_dtls->inv_id ?>')"> -->
						...
						<div class="col-sm-4">
							<div class="box box-default secondblock_bg">
                                ...
                                WHERE
                                    inv_id = '" . $_POST['invoiceid'] . "' and pickup != '1'";
						...
						<table class="table table-hover no-margin fixed_table">
							...
							<tbody id="dispinvnotes">
								...
								if (is_numeric($_POST['invoiceid']) == 1) {
									...
									$notesql = $this->db->query("SELECT * FROM customer_invoice_notes WHERE inv_id='" . $_POST['invoiceid'] . "' ORDER BY id ASC");
								...
								?>
											...
											<tr class="tr_clone">
												...
												<td>
													<?php $dt = date("m/d/Y", strtotime($notesql_dtls->date)); ?>
												...
												<td>
													<input placeholder="HH:MM" type="text" name="note_time" class="form-control notetime cust_inv_note_tim<?= $notesql_dtls->id ?>" value="<?= $notesql_dtls->time ?>" onchange="fnupdatenote(this.value,'<?= $notesql_dtls->inv_id ?>','time','<?= $notesql_dtls->id ?>')" tabindex="-1">
												</td>
									...
									<tr class="tr_clone">
										...
										<input type="hidden" class="txthdninvId" name="txthdninvId" id="txthdninvId" value="<?= $_POST['invoiceid'] ?>">

										<td><input type="text" name="note_date" id="notedate" class="form-control notedate w80 dddd" placeholder="mm/dd/yyyy" onblur="fninsertnote(this.value,'<?= $_POST['invoiceid'] ?>','date')"></td>

										<td>
											<input onblur="cust_inv_note_tim_sta()" placeholder="HH:MM" type="text" name="note_time" class="form-control updwn cust_inv_note_tim_sta" onchange="fninsertnote(this.value,'<?= $_POST['invoiceid'] ?>','time')">
										...
										<td>
											<input type="text" name="note_notes" class="form-control updwn" onchange="fninsertnote(this.value,'<?= $_POST['invoiceid'] ?>','note')">
										</td>
										<td><input type="checkbox" name="note_invchk" value="1" onchange="fninsertnote(this.value,'<?= $_POST['invoiceid'] ?>','invoice')"></td>
										<td><input type="checkbox" name="note_contrct" value="1" onchange="fninsertnote(this.value,'<?= $_POST['invoiceid'] ?>','contract')"></td>
										<td><input type="checkbox" name="note_relse" value="1" onchange="fninsertnote(this.value,'<?= $_POST['invoiceid'] ?>','relese')"></td>
							...
							<thead>
								...
								?>
										...
										<tr class="tr_clone">
											...
											<td>
												<input type="text" name="invoice_tax_rate<?= $invoiceId ?>" id="8 invoice_tax_rate<?= $invoiceId ?>" class="form-control updwn 2" value="<?= $setinvtaxrate ?>" onchange="fnupdateinvoiceinfo(this.value,'<?= $invoiceId ?>','invoice_tax_rate')">
											</td>
											<td>
												<input type="text" name="invoice_country<?= $invoiceId ?>" id="invoice_country<?= $invoiceId ?>" class="form-control updwn" value="<?= $setinvcntry ?>" style=" " onchange="fnupdateinvoiceinfo(this.value,'<?= $invoiceId ?>','invoice_county')">
											</td>
											<td>
												<input type="text" name="invoice_user<?= $invoiceId ?>" id="invoice_user<?= $invoiceId ?>" class="form-control updwn" value="<?= $setinvuser ?>" style="width: 60px;" onchange="fnupdateinvoiceinfo(this.value,'<?= $invoiceId ?>','invoice_user')">
											</td>
